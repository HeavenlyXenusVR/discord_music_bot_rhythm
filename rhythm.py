...
BOT_STAGGER_SLOTS = {
    ...
    "SYMPHONY": 6, "TUNESTREAM": 7, "RHYTHM": 8, "SAPPHIRE": 9, "STRIFE": 10, "LOCKHART": 11,
}
...
@bot.tree.command(name="rhythm_main_setfeedback", description="Choose the text channel for updates, queue actions, and recovery notices.")
@commands.has_permissions(administrator=True)
