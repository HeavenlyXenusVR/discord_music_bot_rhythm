...
@bot.tree.command(name="rhythm_main_fade", description="Customize track fade transitions or let the bot pick smart fade timing.")
...
async def panel(interaction: discord.Interaction):
    ...
    embed = discord.Embed(title="🎛️ RHYTHM Music Control Panel", description="Manage your audio playback directly from these buttons.", color=discord.Color.from_rgb(43, 45, 49))
