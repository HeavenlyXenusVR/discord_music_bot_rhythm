...
Rhythm is one node in the 12-bot Discord music fleet. It owns its queue tables, reports playback state to the shared swarm database, and is controlled directly from Discord, Aria, and SwarmPanel.
