...
# verbatim from lua-shared/swarmlua/); secrets and runtime state stay in env
# files or mounted volumes.
COPY . .

# Start the bot
# CMD handled by compose -- see this bot's port report for the exact
# `command:` line: luajit rhythm.lua
